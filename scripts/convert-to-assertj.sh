...
's/assertThat(\(.*\),.*not(equalTo(\(.*\))))/assertThat(\1).isNotEqualTo(\2)/g' \
's/assertThat(\(.*\),.*not(greaterThan(\(.*\))))/assertThat(\1).isLessThanOrEqualTo(\2)/g' \
's/assertThat(\(.*\),.*not(\(.*\)))/assertThat(\1).isNotEqualTo(\2)/g' \
's/assertThat(\(.*\),.*greaterThan(\(.*\)))/assertThat(\1).isGreaterThan(\2)/g' \
's/assertThat(\(.*\),.*equalTo(\(.*\)))/assertThat(\1).isEqualTo(\2)/g' \
